...
export function Desktop() {
  ...
  return (
    ...
    { /* Experience */ }
    {windows.experience && (
      <div ref={experienceRef} className="tab-bkg rounded-sm shadow-md absolute resize-x resize-y overflow window w-[687px]" id="experiencediv">
        {/* Header */}
    ...
    { /* Projects */ }
    {windows.projects && (
      <div ref={projectsRef} className="tab-bkg rounded-sm shadow-md absolute resize-x resize-y overflow window w-[687px]" id="projectsdiv">
        {/* Header */}
    ...
    { /* Resume */ }
    {windows.resume && (
      <div ref={resumeRef} className="tab-bkg rounded-sm shadow-md absolute resize-x resize-y overflow window w-[687px]" id="resumediv">
        {/* Header */}
    ...
    { /* Interests */ }
    {windows.interests && (
      <div ref={interestsRef} className="tab-bkg rounded-sm shadow-md absolute resize-x resize-y overflow window w-[687px]" id="interestsdiv">
        {/* Header */}
